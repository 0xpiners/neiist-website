...
## [3.0.0](https://github.com/0xpiners/neiist-website/compare/v2.0.0...v3.0.0) (2026-09-05)
...
* about us page new design ([99af392](https://github.com/0xpiners/neiist-website/commit/99af392221c8d313c6c61a75bd7b6be3e79c772a))
* **about-us:** new about us page built dynamically with db membership data ([a32507e](https://github.com/0xpiners/neiist-website/commit/a32507eb4fa8de6e1b403e87b7e0fdc026f437db))
* **about-us:** visual drag-and-drop editor for the about-us page roles hierarchy. Use dnd-kit package. ([d249c58](https://github.com/0xpiners/neiist-website/commit/d249c5890907b91f01ca9102d79fc23bf89bc256))
* Activities page ([e9fb8cb](https://github.com/0xpiners/neiist-website/commit/e9fb8cb8208d9b35c67ad07664340fa9387eff41)), closes [#582](https://github.com/0xpiners/neiist-website/issues/582)
* **activities:** new calendar style and EventsDetails modal ([687b766](https://github.com/0xpiners/neiist-website/commit/687b76678b8971a53186a85102692c83d44b0d3f))
* **ActivitiesSlider:** activities slider for the homepage (needs some admin page to manage or blog integration) ([ea9021a](https://github.com/0xpiners/neiist-website/commit/ea9021a97ce880d51acadab8d34bd1e0245dc4ea))
* add apple pay sumup integration ([c2dbebc](https://github.com/0xpiners/neiist-website/commit/c2dbebc8c61c95765afaea00589a143242a83360))
* add confirmation dialogs for all order realted operations ([062f76d](https://github.com/0xpiners/neiist-website/commit/062f76d9ffb3b059608f068f0d8f05f2c90ade7d))
* add fuse.js to the website, used for all the search functionality ([ddc517b](https://github.com/0xpiners/neiist-website/commit/ddc517b51e54e67529f33e7133f6f1e1a05196cd))
* add new fields to user db now it also store the github and linkdin usernames ([3e1a4a9](https://github.com/0xpiners/neiist-website/commit/3e1a4a9187ae60a3af63b03a59bd08f00e312336))
* add new user role (shop manager) ([6fd8eee](https://github.com/0xpiners/neiist-website/commit/6fd8eee38ff0e0ea01a2865e8a3fd6ddb5723fa1))
* add pickup_deadline to orders (sql, dbUtils and ui/ux) ([ed6a277](https://github.com/0xpiners/neiist-website/commit/ed6a277485563d046809641de8f4db3e0f203479))
* add size guide ([a741474](https://github.com/0xpiners/neiist-website/commit/a74147440b80c4480fb9fda044951bec6dc4c43c))
* add toast feedback to event details actions ([#633](https://github.com/0xpiners/neiist-website/issues/633)) ([9c2183c](https://github.com/0xpiners/neiist-website/commit/9c2183c927d05f5682f59dfc10510bca353e33f4))
* add toast notifications with Soonner ([5af06dc](https://github.com/0xpiners/neiist-website/commit/5af06dc013fca5a3ea4262b72fb1e85e773e912d))
* add trigger on orders to restock limited stock items on order cancellation ([6d64cb2](https://github.com/0xpiners/neiist-website/commit/6d64cb20cf47e1264d8634d3b340f523a3acc3dc))
* added created_by property to orders table. ([ef0b0e7](https://github.com/0xpiners/neiist-website/commit/ef0b0e76d66244e7bc2226acaee56a3cfde0a439))
* admin and coordinators can edit orders (campus, itens, phone ([d060212](https://github.com/0xpiners/neiist-website/commit/d060212089b39be3494f14c7364c24dee43b3285)), closes [#626](https://github.com/0xpiners/neiist-website/issues/626)
* **admin:** admin management pages for departments (teams and admin bodies), roles in each department and their access level, members of each department and their role. ([d72880e](https://github.com/0xpiners/neiist-website/commit/d72880ec8c5a49456de567a4e5985c51821857b1))
* **adminApi:** new admin api, manage user and permissions + code cleanup ([71554a6](https://github.com/0xpiners/neiist-website/commit/71554a6db5daf70d0f771a8aafa54e74a6b44f9e))
* **admin:** wip admin page and collab manaager + user roles ([3c0c32a](https://github.com/0xpiners/neiist-website/commit/3c0c32a3dfb19bf9c21c6685ceacee7f9bb80bc3))
* **auth:** add OAuth state cookie for CSRF protection ([3405bd8](https://github.com/0xpiners/neiist-website/commit/3405bd88b0a87bb958d1e0451279d631d6c6f662))
* **auth:** implement refresh token endpoint ([2c37009](https://github.com/0xpiners/neiist-website/commit/2c37009dbe5747b0d0499db7de5de9ad956a04a4))
* **auth:** persist return URL across OAuth flow and restore after login ([e1b89e3](https://github.com/0xpiners/neiist-website/commit/e1b89e32fb9852fc0d867ce7732d7d33cf0ca5d5))
* **cache:** add revalidateTag to all mutation API routesupdateTag ([a3a96a1](https://github.com/0xpiners/neiist-website/commit/a3a96a10c4d3a753461e9fd81f3e3bc05e3824cb))
* **cart:** improve item spacing and update imageWrapper max-width ([e58a189](https://github.com/0xpiners/neiist-website/commit/e58a189ae48d94ef8f9a6de602a05db17ae59ec8))
* centraize email sending logic nodemailer util ([453c532](https://github.com/0xpiners/neiist-website/commit/453c5328d7ed3d7adf60d20b7c793892087bf081))
* checkout page ([a8f883f](https://github.com/0xpiners/neiist-website/commit/a8f883f8a463753395bd42a4f0e66553574a9fbf))
* **ci:** add lint, type check and formating to an action run ([d49db3b](https://github.com/0xpiners/neiist-website/commit/d49db3b72220c4d00f948ee83cd81f8e63a8b7ca))
* close shop only acessible for admins ([d8ee7ea](https://github.com/0xpiners/neiist-website/commit/d8ee7eafe63c68637051eb8d7817005b8ab3be17))
* **confirm-dialog:** new confirmation dialog to use in place of the ([d215733](https://github.com/0xpiners/neiist-website/commit/d215733806a786d264e8e4c6597884f85e50f3a9))
* copiable public google calendar link ([b4df249](https://github.com/0xpiners/neiist-website/commit/b4df2496d0864840bdfe83a844909411fb31cfea))
* corrected emails information and made campus an required field ([bb8b60b](https://github.com/0xpiners/neiist-website/commit/bb8b60b186a1330e8a4bcb49e476083645f8c793))
* **cron:** use a next cron job to auto cancel any order that is still pending 72h after it was created ([cacc02e](https://github.com/0xpiners/neiist-website/commit/cacc02e43a750c6d837ef8fd76acc565eb10c1e0))
* **database:** shema store user data and retriving ([1193af0](https://github.com/0xpiners/neiist-website/commit/1193af0207a207f5d862058b325710ed0715d53d))
* **db:** add sql batch functions (memberships, department roles, products) and stale order query ([a38f3ce](https://github.com/0xpiners/neiist-website/commit/a38f3cebfe2e973b7173ff6ccaeab06b7683fa4c))
* **db:** allow products to be deleted and trigger to update products of old orders ([bca1752](https://github.com/0xpiners/neiist-website/commit/bca175262039a855834a1697eedaa18e4abc7169))
* **db:** database backend users, admin, members and collab ([494439b](https://github.com/0xpiners/neiist-website/commit/494439b232fe130364080227c5b79282ba878b36))
* **db:** normalize database to 3NF/BCNF all functions updated to send data in a trasnparent way to the application ([c761de4](https://github.com/0xpiners/neiist-website/commit/c761de418163e7eea9d28ac14f72739e298dd209))
* **deploy:** add deploy actions ([28ccfd6](https://github.com/0xpiners/neiist-website/commit/28ccfd6d64754cc8e5452c431a1ba29d45105cf3))
* **deploy:** add deploy scripts ([6dc84c0](https://github.com/0xpiners/neiist-website/commit/6dc84c052f78005f10b954d15d9330cbb6c324af))
* dinner page layout, styles, and content ([4c06489](https://github.com/0xpiners/neiist-website/commit/4c06489ef3a6f894327c13221a181e4380518c40))
* **dinner:** add voting button and styles to UnlockedDinnerPage ([b662315](https://github.com/0xpiners/neiist-website/commit/b662315ef79891067de0e8bf97b2e353cfdb5c69))
* **dinner:** disable dinner page (only for admins, remove from nav) ([cbc45e7](https://github.com/0xpiners/neiist-website/commit/cbc45e7fe8963b8b26f07f90ea8d7a2c7b8faee3))
* **drive:** separated util for drive upload and jwt crypto fix ([aa01bf3](https://github.com/0xpiners/neiist-website/commit/aa01bf378ea4a03e520f8d573eeb47938e046d56))
* **email-verification:** Use nodemailer to send a confirmation when a user sets a secondary email. Confirmation page and email template. Api route to confirm and send magic link email. ([ce7b07d](https://github.com/0xpiners/neiist-website/commit/ce7b07d24a46be7ef60c6462be40aaa30cf20d23))
* **error:** add error page, default error pages ([46d00ff](https://github.com/0xpiners/neiist-website/commit/46d00ff94e177661591e9d571aa2d832dab579e5))
* **events-activities:** store evenst/activities data on db, admin page for managment. Moved events images to public folder. ([3ac708e](https://github.com/0xpiners/neiist-website/commit/3ac708e9912aaaae4a9bdfb08e29d71b1d8c65f8))
* **eventsDetails:** description with support for web links ([7a45740](https://github.com/0xpiners/neiist-website/commit/7a4574006d0ae9581255268e5839f1b7a582663e))
* flyout dropdown menu for choosing the products varient ([331b5b9](https://github.com/0xpiners/neiist-website/commit/331b5b9e7075050d7431b404672c9102e854dcd2))
* **footer:** implement responsive footer ([109cf20](https://github.com/0xpiners/neiist-website/commit/109cf20a2ea3b95a447acd989dd252c7d17b7294))
* Google Calendar integration with Notion using service account ([e412482](https://github.com/0xpiners/neiist-website/commit/e412482927b59d766f7b2abbfe8173400f537790))
* **Hero:** new homepage hero ([c754663](https://github.com/0xpiners/neiist-website/commit/c7546634a89fa46a65f089bdc13fef7e5928957e))
* **homepage:** SINFO and Partnerships styled +  Activities component (not styled) ([fedb9f3](https://github.com/0xpiners/neiist-website/commit/fedb9f322e8fe75d6d0ca29c095c7e14dcfbf523))
* **i18n:** add cookie-based i18n (en, pt) with server-side dictionaries ([f0bfd19](https://github.com/0xpiners/neiist-website/commit/f0bfd19382a4a58cc21ddeec706f2e789bd90fe3))
* ical feed from notion api, direct link on profile to add to google calendar ([6ef2387](https://github.com/0xpiners/neiist-website/commit/6ef2387b0b05e0bb07ed6e1c5e94b9bf90c57875))
* implement better search logic in MembershipsSearchList ([43d7768](https://github.com/0xpiners/neiist-website/commit/43d776850581a942812a2f55bccad93e035afcf2))
* implement better search logic in OrdersTable ([3ec68b0](https://github.com/0xpiners/neiist-website/commit/3ec68b05b9fa7845b649ad09125d29f0172f0013))
* implemented a better search logic in PhotoTeamMembers ([6f2939f](https://github.com/0xpiners/neiist-website/commit/6f2939f8f016b2eb87292922371e9f4a41f0417d))
* improve search logic in UsersSearchList ([bf36cf3](https://github.com/0xpiners/neiist-website/commit/bf36cf33fb3efbb914c906a9f2f89e6a666e32ae))
* JoinUs component for the about us ([83c5b36](https://github.com/0xpiners/neiist-website/commit/83c5b360b389090703f8eae90445a39ee1a69d49))
* **joinUs:** add join us banner to about us page ([e34f0a0](https://github.com/0xpiners/neiist-website/commit/e34f0a07a72e9c73b816a0f6bf23b33c472b28b5))
* jwt for user data signing and verification ([3489377](https://github.com/0xpiners/neiist-website/commit/3489377a4d533eaa4178cef65525dd2cae73bfcf))
* load google service accouts from env not from json files ([b173609](https://github.com/0xpiners/neiist-website/commit/b17360982087fee3f3831fb9a336bd46498d558f))
* **management:** separate admin pages into two one to manage users and members other to manage the departments strutures ([afa45e8](https://github.com/0xpiners/neiist-website/commit/afa45e8162872ae678a1ceb3e2fd4ce749d611b1))
* **management:** teams and user management api routes added. Fixed a small issue with permission and user roles on the api routes and middleware. ([3a15d09](https://github.com/0xpiners/neiist-website/commit/3a15d09640ce1e066f7aebced759330ba2e0d091))
* mbway for jantar de curso (update emails and payment pages). New util to select the mbway number from a list ([3ab3e25](https://github.com/0xpiners/neiist-website/commit/3ab3e25b51e0531e98125ac3cf6271f0390d72a9))
* migrate google api to google service accounts. Script to backup db prod and staging ([bc83bc4](https://github.com/0xpiners/neiist-website/commit/bc83bc461d92065d7f4f51804b3de97ed47a267a))
* my orders page + order management page + create new orders from managment page ([6d3aad8](https://github.com/0xpiners/neiist-website/commit/6d3aad88dfaf87dc917c443d47b5717e8beabc98))
* my orders page with filters ([8dad2a8](https://github.com/0xpiners/neiist-website/commit/8dad2a8ebf524fc388a3f0fe4e4997e48c82bc30))
* navbar menu animations + refactor and new css variable names ([f433f59](https://github.com/0xpiners/neiist-website/commit/f433f59c67734f2748867213f7c750db793b3e06))
* **navbar:** all mobile menus working and srcoll sticky ([50d437a](https://github.com/0xpiners/neiist-website/commit/50d437ad11be7b5c49b08ae11f6d2bad778dea9d))
* **navbar:** language switcher on mobile is on the dropdwon menu ([8150103](https://github.com/0xpiners/neiist-website/commit/8150103f8a656175cda76d76ec989b8484448cd5))
* **navbar:** new color scheme and layout ([10e9f81](https://github.com/0xpiners/neiist-website/commit/10e9f8176f805ed4a058a6c253b0d0df7c8c6d77))
* **navbar:** new navbar design ([cd1e186](https://github.com/0xpiners/neiist-website/commit/cd1e1867e16209d9e33fd9d74ae5c9e9fa0412fe))
* **navbar:** User profile menu refactor. ([3c1cb61](https://github.com/0xpiners/neiist-website/commit/3c1cb61669cd13faf2641ce8676c30231402b032))
* new cvBank api using google service account and in-memory cache ([89a921e](https://github.com/0xpiners/neiist-website/commit/89a921e2ce635c53763e2ab7a50433c316e25829))
* new filters ui/ux with filters per data column and dedicated mobile ui for filters ([16501b2](https://github.com/0xpiners/neiist-website/commit/16501b225f2c859282b197ee88d3d50a7e8dac53)), closes [#621](https://github.com/0xpiners/neiist-website/issues/621)
* new fuzzy search paraments ([6820b8d](https://github.com/0xpiners/neiist-website/commit/6820b8d55e37c6af61f63ec119e9a392ab130742))
* new middleware + api's for updated db structure ([e09bade](https://github.com/0xpiners/neiist-website/commit/e09bade9a454e7abe46011e982d08b822505f216))
* new Profile Page design and CV-Bank ([2bf8869](https://github.com/0xpiners/neiist-website/commit/2bf8869cf68022d8c8388ee16a8c9a1b0f216c51))
* new styling calendar component ([e6c9566](https://github.com/0xpiners/neiist-website/commit/e6c956659df63450f5bdbd554a6f6c2bea4d03ac))
* new unified user roles checks ([b3d8c30](https://github.com/0xpiners/neiist-website/commit/b3d8c306f093e5a6509f0ec46410b038db16b9ab))
* next-js rewrite initial commit ([b1ff579](https://github.com/0xpiners/neiist-website/commit/b1ff5792b55b4ebee8bf92957bb03bd45ca344db))
* order details manager overlay ([5a9bc0c](https://github.com/0xpiners/neiist-website/commit/5a9bc0ce5696ca34ca8b9009826572492442fc27))
* order notes editing ([e0112b1](https://github.com/0xpiners/neiist-website/commit/e0112b13a227792ff7b1273ab0f8848034011aca)), closes [#626](https://github.com/0xpiners/neiist-website/issues/626)
* orders management page with filters for status and search ([2a1eb5a](https://github.com/0xpiners/neiist-website/commit/2a1eb5a69b70527132c717107fa5cf89fa07984e))
* **orders:** add archive option (only show current academic year orders) ([1c4a182](https://github.com/0xpiners/neiist-website/commit/1c4a182195855ae991477f254344e4f584ae67dd))
* **orders:** admin can override stock or order deadline when adding ([4a30c0e](https://github.com/0xpiners/neiist-website/commit/4a30c0e67c85be217431124e1c3098ce21fab4c0))
* **orders:** choose google account before opening gmail. ([c8fd469](https://github.com/0xpiners/neiist-website/commit/c8fd469298c8da39257ba58f381073bba231c75c))
* **orderStatus:** refactor order status so they are centerlized and can ([dc0d287](https://github.com/0xpiners/neiist-website/commit/dc0d287dff9d2b9999d1e6eff6c3d2eaa168d9e2))
* **permissions:** centralize all roles and permissions checks ([62ad383](https://github.com/0xpiners/neiist-website/commit/62ad383a58a4459fd060e04ef61f22f2d61bd872))
* **photo-upload:** upload custom photos and cache/save fenix photos. ([a3a1eac](https://github.com/0xpiners/neiist-website/commit/a3a1eacfdb21fe349366e8de1755d90b9c3d402d))
* **photo:** new page for photo coordinator to change photos for all members. ([7c74f38](https://github.com/0xpiners/neiist-website/commit/7c74f38e18eb5cdcff61302cca13846b2b91c164))
* **photos:** admins can set custom photos for the users. ([756ab67](https://github.com/0xpiners/neiist-website/commit/756ab67cb0f16d0b2e3c7596e219ad9553ef9ef9))
* **pre-commit:** setup pre-commit hooks with husky ([ab98d15](https://github.com/0xpiners/neiist-website/commit/ab98d15a5b5232f733abeca56350b84a666d388e))
* **product detail:** add expandable Size Guide and Quality Guarantee sections ([a272898](https://github.com/0xpiners/neiist-website/commit/a272898d06d30d5bd56cf618d0f2314c7e4c5c78))
* **product-detail:** UI improvements, spacing fixes and variant selector update ([d37ff6b](https://github.com/0xpiners/neiist-website/commit/d37ff6b3328e4227cf0683745f7af50f09450442))
* **ProductDetail:** add markdown redering format support ([47553d4](https://github.com/0xpiners/neiist-website/commit/47553d43c6f841ed5fc7db16af32e98909e77e07))
* **profile-page:** User profile page with prefered contact method. ([5196272](https://github.com/0xpiners/neiist-website/commit/5196272d1e654677717cf54700e387316234fe1e))
* **profile:** refactor profile page ([5df73f1](https://github.com/0xpiners/neiist-website/commit/5df73f1ce903493428c157965bba78d31237eee2))
* **profile:** wip profile page ([7c8a2e1](https://github.com/0xpiners/neiist-website/commit/7c8a2e1ef4ab30d9ddcf3e14f598acbefec07607))
* **refactor:** refactor code of admin and collaborator managemnt pages. ([764f0aa](https://github.com/0xpiners/neiist-website/commit/764f0aacc562876fd6c0dac0680b623c9d406236))
* rollback to old cvbank api (service account on personal doesnt have storage write access) ([5ca890e](https://github.com/0xpiners/neiist-website/commit/5ca890e6beba86c8f8c4028c53fd377ed95cabfa))
* **search:** new universal search, implemented with mini search engine ([a69122c](https://github.com/0xpiners/neiist-website/commit/a69122c9bc89008bfd06bbc0d097f7496ba1fda0))
* **security:** add bot protection, sitemap and robots.txt ([09d1a49](https://github.com/0xpiners/neiist-website/commit/09d1a49438438b8d9f6113f30644c9a5de3b38a4))
* **security:** add rate limiting and CSP headers ([58b86d1](https://github.com/0xpiners/neiist-website/commit/58b86d1771fc5a7b01f4642f2e9717915c15b863))
* send email to selected users ([1d9bade](https://github.com/0xpiners/neiist-website/commit/1d9bade7a9311693a48c6880203d122c38bfa5b1))
* **setup script:** add a setup script to create the dev env ([9ecd024](https://github.com/0xpiners/neiist-website/commit/9ecd024dac47168183b00d75f9a917526833e264))
* shop categories, product varients and images. Create, edit, and remove products variants and stocks. Updated postgres db init.sql ([e4c2c36](https://github.com/0xpiners/neiist-website/commit/e4c2c360ceff2ef711ed98fcea31ec62940938b0))
* shop product cards with thumbnails for all colors or variants of the product. Shop Product management with creation of variants like color and size (one product multiple colors and sizes) ([4213376](https://github.com/0xpiners/neiist-website/commit/42133765202c426163c487c29b7621bfe90b4ef5))
* **shop:** add cascading flyout menu to filter product variants ([8c84070](https://github.com/0xpiners/neiist-website/commit/8c84070c3a00807b96d21a05af4d376386826be8))
* **shop:** add estimated delivery and customizable size SizeGuideEditor ([c5e6786](https://github.com/0xpiners/neiist-website/commit/c5e678610389fad87972c2026f72aee6d276b57a))
* **shop:** add order_start sql functions logic and UI updates ([8409e22](https://github.com/0xpiners/neiist-website/commit/8409e2250a74e77ee4fef9f42928bda9b2fcfdd5))
* **shop:** add sumup readers management and pos payment flow(send payment to physical tpa) ([395f99b](https://github.com/0xpiners/neiist-website/commit/395f99b202e47bfc24b402f2d56a3ea67f1c5625))
* **shop:** allow selling to guest user for now only admin can via ([a3f9651](https://github.com/0xpiners/neiist-website/commit/a3f96514f2f194dc9962e224859e10f74ac7095c))
* **shop:** discount codes. Ability to create and manage codes, send ([b2165b7](https://github.com/0xpiners/neiist-website/commit/b2165b7ade394e0cea6f05fcfa8bb55b69538cc4))
* **shop:** introduce campus schedule modal and unify pending payment overlays ([5a1eea0](https://github.com/0xpiners/neiist-website/commit/5a1eea0046fe17b7e8ed3049d82f0114034abb9a))
* **shop:** main shop page and data types ([c7644bc](https://github.com/0xpiners/neiist-website/commit/c7644bc8ebc4accb6128362d5bb210c365886dc5))
* **shop:** new product management page complete ([8a13ef7](https://github.com/0xpiners/neiist-website/commit/8a13ef7f60550090372e5ed8ed1148fe1ead7767))
* **shop:** new shop homepage layout and product details page ([3b1d083](https://github.com/0xpiners/neiist-website/commit/3b1d0836d509ce668101619887d088860a49eca1))
* **shop:** products management page (css wip) no image upload ([1be4ac1](https://github.com/0xpiners/neiist-website/commit/1be4ac10d8677739d68bdf3b7814d9a0c13a1589))
* **shop:** special categories that override some specific flows on the shop experience ("Jantar de Curso" e "Churrasco") ([1eda52a](https://github.com/0xpiners/neiist-website/commit/1eda52a3a829ff55c00d4b598fb0355eb1224c48))
* **shop:** sql tables and functions in 3NF. Data types for shop products and orders. DB init file updated to have sample products. ([d3fbcda](https://github.com/0xpiners/neiist-website/commit/d3fbcda0e836d045c60639bb0f0e8df85f4ac207))
* **shop:** startup instrumentation for auto-cancel and db seeding ([3778099](https://github.com/0xpiners/neiist-website/commit/3778099b55bcda195af2cdecef1206ea2c3b87d6))
* **shop:** stock and order deadline enforced in sql (custom execptions). Updated api routes and frontend to reflect this changes. Shop open but products are displayed but cannot be bought. ([a09c238](https://github.com/0xpiners/neiist-website/commit/a09c238760a84982464f472074c0baead4adf736))
* **shop:** variants and names of products all centralized. Clean up and ([b789e2e](https://github.com/0xpiners/neiist-website/commit/b789e2e6d5483468cd40061c1b7d123c88e7e7ef))
* show orders notes on the order details overlay ([4b758c1](https://github.com/0xpiners/neiist-website/commit/4b758c11c9d6b99556feaae53fa70808508028e7))
* SumUp integration with iframe widget ([af42694](https://github.com/0xpiners/neiist-website/commit/af42694d42e59df7ddcf918f6f0a45cb00bb1a4f))
* sweats design contest banner and submissions google drive api ([bcb00ef](https://github.com/0xpiners/neiist-website/commit/bcb00ef3c2c3ae191f4d127e6e9d99ccbd724c75))
* sweats design contest ended (remove from homepage, disable api) ([feb864d](https://github.com/0xpiners/neiist-website/commit/feb864d4ae97a173aa4c78fca732f3167c38e32b))
* **team-management:** new coordinator team management page to manage ([cde20a4](https://github.com/0xpiners/neiist-website/commit/cde20a46ae7edb32d648fc54bd3033debdaeac3e))
* the cool student now loops arround, we can never leave tecnico ([b5090af](https://github.com/0xpiners/neiist-website/commit/b5090af2476344f339a13d147d0c4879a222fe2c)), closes [#600](https://github.com/0xpiners/neiist-website/issues/600)
* **theme:** implemented dark mode using next-themes defaults ([5f604a5](https://github.com/0xpiners/neiist-website/commit/5f604a58bcdc34e80d040a2fb4a82e704010a024))
* **themeToggle:** fixed animation and icon ([3cf4645](https://github.com/0xpiners/neiist-website/commit/3cf4645c000bc5029a5e25fae1667574001c381f))
* **unauthorized:** new unauthorized access page ([85d6391](https://github.com/0xpiners/neiist-website/commit/85d639159200373715efed5f7e0910a1dc8622cb))
* update packages with security vulnerabilities ([141b9f8](https://github.com/0xpiners/neiist-website/commit/141b9f832050197dfe030752cb57e86bd6c7cf22))
* **UserContext:** save user context after login ([90fe9e0](https://github.com/0xpiners/neiist-website/commit/90fe9e0aba9f79da163e5017c3dda726a57e5aeb))
* **user:** implement GDPR-compliant account deletion with order pii redaction ([4a7e820](https://github.com/0xpiners/neiist-website/commit/4a7e820f6fbea77e8ce313359e5607bd26d3bb1c))
* **voting:** better mobile ui, voting session tabs, vote feedback, and route suspense ([67e40cc](https://github.com/0xpiners/neiist-website/commit/67e40cc55cc49460dd37d8281dda69b48456a383))
* **voting:** new pg_notify based SSE backend. New pages for management, vote and wait for voting to start. Make shop filtering components universal. ([9d1422e](https://github.com/0xpiners/neiist-website/commit/9d1422e6b42192e4fb84f627d638559edc7df141))
* **votingSystem:** optimize SSE pub/sub architecture and fix stale state amnesia ([41154f9](https://github.com/0xpiners/neiist-website/commit/41154f91d36e34e240d4f1cfdaf04261b83cc8e7))
* **voting:** voting system using postgres state sync between client ([5d0a9f9](https://github.com/0xpiners/neiist-website/commit/5d0a9f901ef9c896915e561e9a00b6afa3dba499))
* yarn script using changeset package for automatic versioning and changelog generation ([ad60c90](https://github.com/0xpiners/neiist-website/commit/ad60c909d6ee8bf751ee8f812f1c097a94432e52))


### Bug Fixes

* (activitities): carroussell now only stops autoplay on hover. On db name of events needs to be unique ([2608645](https://github.com/0xpiners/neiist-website/commit/2608645b30e0ca8aa8cdf147cbbdbc9b03852f08))
* about us page academic year logic and showing old deactivated departments. ([bfc8dcd](https://github.com/0xpiners/neiist-website/commit/bfc8dcd46343b72359d280f73730fb8c5fcf5601))
* academic year and memberships filter on about us page ([5e6fd1a](https://github.com/0xpiners/neiist-website/commit/5e6fd1a06871e5d2ddd66dba90679a369661ee34))
* activities and hero scalling ([32061d3](https://github.com/0xpiners/neiist-website/commit/32061d3f0e7f81623ac57942f5fca2088feae084))
* activities carroussell no data on the db ([55a8524](https://github.com/0xpiners/neiist-website/commit/55a8524738cba630585e3ddd7f79be4d6521900c))
* add and remove functions teams and admin bodies ([49fa4a0](https://github.com/0xpiners/neiist-website/commit/49fa4a04af3039cce95847dd2f82d2c383996a30))
* add cart item counter ([71637eb](https://github.com/0xpiners/neiist-website/commit/71637ebcd5e371bb2dcd24bdad1bfd153601b1fd))
* add more than six variants, use of db ids and random ids ([a2530b2](https://github.com/0xpiners/neiist-website/commit/a2530b2bf86d471c69ba59e642a5353bc362595a))
* add product image routes to local patterns ([6e06a95](https://github.com/0xpiners/neiist-website/commit/6e06a95e3ab1daf5e9857eb8302368ff5e369559))
* admin bodies doesn't have a descprition, team descprition is required, active and inactive filters now filter the data correctly ([0758673](https://github.com/0xpiners/neiist-website/commit/07586733e420316c4aba90df08298b4b7985fc62))
* **api-admin:** fixes to permissions and data type on the admin api functions and database access. ([9ebc0cd](https://github.com/0xpiners/neiist-website/commit/9ebc0cd178277358693bb58f244cfed0a990da20))
* **api:** nextjs pre-render breaking and using NextRequest to parse url ([e3dd516](https://github.com/0xpiners/neiist-website/commit/e3dd5164270606381905e5c1d379de9952efaf82))
* **api:** use correct base url on callback route fenix ([181420b](https://github.com/0xpiners/neiist-website/commit/181420b802eafbabef699b04f6938484638a0aa4))
* **app:** wrap user context in suspense and add app general loading spinner ([b500ed4](https://github.com/0xpiners/neiist-website/commit/b500ed413130b3413812c0ca736d1e0a5125a739))
* **auth:** auth and account creation for user with multiple courses ([20c9d69](https://github.com/0xpiners/neiist-website/commit/20c9d69e7f8e3f9e7a09b6d5f0da00a47ee5a38d))
* **auth:** await cookies() outside of try/catch block so it doesnt break ([59d4424](https://github.com/0xpiners/neiist-website/commit/59d442420ca3f302b3fbc5a2bfd5d690fd0f3ed9))
* **auth:** callback/lougout route use env variable instead of request ([768b1d0](https://github.com/0xpiners/neiist-website/commit/768b1d0a2ec7614618a37c9150e3927eebdb714c))
* **auth:** fix post-login destination redirects and refactor server auth helpers ([f2a77e4](https://github.com/0xpiners/neiist-website/commit/f2a77e404e20435ae09a041fcea8b9425e4f1771)), closes [#678](https://github.com/0xpiners/neiist-website/issues/678)
* **auth:** migrate to standard Web Crypto API for JWT verification and signing ([9a8c83d](https://github.com/0xpiners/neiist-website/commit/9a8c83d497c01085cd1a3857444d4ca95144f212))
* **auth:** protect routes and server pages with requireRoles using new jwt, order PII Redaction ([8417213](https://github.com/0xpiners/neiist-website/commit/8417213ed3c0f62d3cfcf9267a72f9ed90c115f4))
* auto expand notes on modal open when notes exist ([0882504](https://github.com/0xpiners/neiist-website/commit/08825048f11a38659123cb489d7892cec573a4e0))
* Better type safety on user data from db. ([17b4e14](https://github.com/0xpiners/neiist-website/commit/17b4e149e308aebdc616a67bc67cd8912c451263))
* **calendar-rate:** adjust google calendar api rate limit ([5b4b08e](https://github.com/0xpiners/neiist-website/commit/5b4b08eafd0d80f90ff90e1cc6de596f97d3aa05))
* **calendar:** decouple notion webhook response from events sync to db ([de02d33](https://github.com/0xpiners/neiist-website/commit/de02d3319c3d6de372ef40bc694a293124b76e00))
* **calendar:** service account json parsing permissions ([4b43fe5](https://github.com/0xpiners/neiist-website/commit/4b43fe5e6eb9b157633ef1b7d94c7ccafa0efbc9))
* callback fenix api ([11ae5b1](https://github.com/0xpiners/neiist-website/commit/11ae5b17ca6745763855ce6143440c6675ede341))
* CartItem data type for ShopContext and Cart component. ([8b56788](https://github.com/0xpiners/neiist-website/commit/8b5678867a23ecf11786d3bdc5c78641526f6c05))
* **cart:** show price and "remove button" for products without variants ([1e9ddd0](https://github.com/0xpiners/neiist-website/commit/1e9ddd04009076512606eda55407c87eccc186ea))
* categories edting and creation on product form and categories view and save on cart ([acd7231](https://github.com/0xpiners/neiist-website/commit/acd72310f55b6222dcfe7ac7d86c7121f0d1b7aa))
* **ci:** generate nextjs types before running lint and type checker ([74f092f](https://github.com/0xpiners/neiist-website/commit/74f092f5167147e22536ce55ae3c50b16c7ff554))
* **ci:** make deploy workflow depend on the lint workflow ([99ab3bd](https://github.com/0xpiners/neiist-website/commit/99ab3bd35be7abed9267bdd1b77cfaa844766919))
* **ci:** stage deploy blocked until sucessful linting ([b4e0724](https://github.com/0xpiners/neiist-website/commit/b4e07243e9468572497aef5c19d34a71cd6ec54c))
* corrected small errors in setup docs and scripts ([34f9f3a](https://github.com/0xpiners/neiist-website/commit/34f9f3a619516ec659b6081f97a6c80de6d996ae))
* correctly format pdf cv download ([43ee79a](https://github.com/0xpiners/neiist-website/commit/43ee79ae7e97d71b74531228c4e3b2abbe85402c))
* **datetime:** fix rendering of data and time ([7a04034](https://github.com/0xpiners/neiist-website/commit/7a0403490ff8a99154726a2065d56ed637facd89))
* db schema sql ids ([6c4b93a](https://github.com/0xpiners/neiist-website/commit/6c4b93a796953572ccddf04b6b359dc896791299))
* **db:** remove duplicated functions ([c6ae32a](https://github.com/0xpiners/neiist-website/commit/c6ae32a6b5025e6fbf0b56a1ac78900a5f004185))
* **db:** sql add_user function missing DEFAULT NULL for p_github and p_linkedin ([c002b16](https://github.com/0xpiners/neiist-website/commit/c002b1675803875f49211d2bcce9f95e87e089ea))
* department managment requirement to add at least one role when creating a new one. ([927b43d](https://github.com/0xpiners/neiist-website/commit/927b43d1de4a2476b1bfe5a35a0c2456b5e19422))
* deploy actions ([367e291](https://github.com/0xpiners/neiist-website/commit/367e291d5d629f817e154a8220cc4c642234a381))
* **deploy:** correct git tags fetching on the server ([ca2a9ec](https://github.com/0xpiners/neiist-website/commit/ca2a9ec14cbfa2a37fbeacb1f67cc71a3c5755ca))
* **deploy:** correct nvm path ([4aa8122](https://github.com/0xpiners/neiist-website/commit/4aa8122c9fa5a4c5febf28422fb3ab1f90eb0872))
* **deploy:** pm2 check on github action ([7df9229](https://github.com/0xpiners/neiist-website/commit/7df9229fc572f2907cafe607e07dbeaacfb2f35c))
* **deps:** update dependency axios to v1.10.0 ([#497](https://github.com/0xpiners/neiist-website/issues/497)) ([181138a](https://github.com/0xpiners/neiist-website/commit/181138acc6af10b06b61456d354dddd2396c16a0))
* **deps:** update dependency axios to v1.11.0 [security] ([#526](https://github.com/0xpiners/neiist-website/issues/526)) ([31c8820](https://github.com/0xpiners/neiist-website/commit/31c88201c97359f6534d54e00fd454c78685b4ca))
* **deps:** update dependency axios to v1.12.0 [security] ([#559](https://github.com/0xpiners/neiist-website/issues/559)) ([7f1e5b4](https://github.com/0xpiners/neiist-website/commit/7f1e5b4eb00da4f1ee1e36b7fa46fce034c1560c))
* **deps:** update dependency axios to v1.12.2 ([#561](https://github.com/0xpiners/neiist-website/issues/561)) ([623de41](https://github.com/0xpiners/neiist-website/commit/623de41a800254be7498973208b0971eb61da64c))
* **deps:** update dependency bootstrap to v5.3.7 ([#484](https://github.com/0xpiners/neiist-website/issues/484)) ([7e8de79](https://github.com/0xpiners/neiist-website/commit/7e8de79f82ff7d269cf473913b8943ecca1ceb37))
* **deps:** update dependency bootstrap to v5.3.8 ([#553](https://github.com/0xpiners/neiist-website/issues/553)) ([51b30a5](https://github.com/0xpiners/neiist-website/commit/51b30a51be4db23e517c145870781eeaec0f57c9))
* **deps:** update dependency dotenv to v17 ([#504](https://github.com/0xpiners/neiist-website/issues/504)) ([159e857](https://github.com/0xpiners/neiist-website/commit/159e85787dfb6514fd898ce15316df99bfaae53b))
* **deps:** update dependency dotenv to v17.0.1 ([#505](https://github.com/0xpiners/neiist-website/issues/505)) ([33cca2b](https://github.com/0xpiners/neiist-website/commit/33cca2b6bdc25bbe0a12829506347c20cfa64b90))
* **deps:** update dependency dotenv to v17.2.0 ([#509](https://github.com/0xpiners/neiist-website/issues/509)) ([6ded998](https://github.com/0xpiners/neiist-website/commit/6ded998e6ed919544d04fe08eeb1b47e9c753cb0))
* **deps:** update dependency dotenv to v17.2.1 ([#529](https://github.com/0xpiners/neiist-website/issues/529)) ([399e2e9](https://github.com/0xpiners/neiist-website/commit/399e2e9a6501be7c337a0cea4d8755d80a3068d5))
* **deps:** update dependency dotenv to v17.2.2 ([#555](https://github.com/0xpiners/neiist-website/issues/555)) ([dc66fc9](https://github.com/0xpiners/neiist-website/commit/dc66fc97345ee4e3b5ff50219c6c301e8d9a84d5))
* **deps:** update dependency express-fileupload to v1.5.2 ([#507](https://github.com/0xpiners/neiist-website/issues/507)) ([858cfd2](https://github.com/0xpiners/neiist-website/commit/858cfd2ad3ac77280f41eaee983fe24d16f1e71c))
* **deps:** update dependency express-session to v1.18.2 ([#517](https://github.com/0xpiners/neiist-website/issues/517)) ([72a8c38](https://github.com/0xpiners/neiist-website/commit/72a8c38899435af9cf4ca6bddf91f333209d731b))
* **deps:** update dependency html-react-parser to v5.2.5 ([4950fac](https://github.com/0xpiners/neiist-website/commit/4950facd31515031ed3ae50e4f2791c023a4d441))
* **deps:** update dependency html-react-parser to v5.2.6 ([#520](https://github.com/0xpiners/neiist-website/issues/520)) ([c09afec](https://github.com/0xpiners/neiist-website/commit/c09afec89e50bc692968421e092eec0a9c509c6d))
* **deps:** update dependency morgan to v1.10.1 ([#518](https://github.com/0xpiners/neiist-website/issues/518)) ([d5c7493](https://github.com/0xpiners/neiist-website/commit/d5c74937af0959dd281f4bf8fdff45ee016a4d4c))
* **deps:** update dependency natural to v8.1.0 ([#499](https://github.com/0xpiners/neiist-website/issues/499)) ([bf03a37](https://github.com/0xpiners/neiist-website/commit/bf03a37185813e9561c7ef0b471bb5cedc73d9c7))
* **deps:** update dependency pg to v8.16.3 ([#500](https://github.com/0xpiners/neiist-website/issues/500)) ([582eca5](https://github.com/0xpiners/neiist-website/commit/582eca5e3584a0eff19d81c2e7b9acab09cc047e))
* **deps:** update dependency react-bootstrap to v2.10.10 ([093254a](https://github.com/0xpiners/neiist-website/commit/093254a37e7b650fd992b3cc2360fa1b6e5e1c05))
* **deps:** update dependency react-multi-carousel to v2.8.6 ([#452](https://github.com/0xpiners/neiist-website/issues/452)) ([d8e095d](https://github.com/0xpiners/neiist-website/commit/d8e095d1ef51ed37eddc10c8c297a862baa2bf57))
* **deps:** update dependency react-router-dom to v7.6.3 ([#478](https://github.com/0xpiners/neiist-website/issues/478)) ([40d56b2](https://github.com/0xpiners/neiist-website/commit/40d56b20f414e82c89f25edf41e5f7c42df8989f))
* **deps:** update dependency react-router-dom to v7.7.0 ([#515](https://github.com/0xpiners/neiist-website/issues/515)) ([f5a4725](https://github.com/0xpiners/neiist-website/commit/f5a4725cbe8b3269bf516a5f0db0265bcee3b723))
* **deps:** update dependency react-router-dom to v7.7.1 ([#528](https://github.com/0xpiners/neiist-website/issues/528)) ([6b946c4](https://github.com/0xpiners/neiist-website/commit/6b946c4bbf5c7b174a986bf9a036f17d9445881c))
* **deps:** update dependency react-router-dom to v7.8.0 ([#542](https://github.com/0xpiners/neiist-website/issues/542)) ([0b79103](https://github.com/0xpiners/neiist-website/commit/0b79103caca3db46f0573d43f9812a559f8ce3ae))
* **deps:** update dependency react-router-dom to v7.9.1 ([#549](https://github.com/0xpiners/neiist-website/issues/549)) ([2840cf6](https://github.com/0xpiners/neiist-website/commit/2840cf65d8c31274870f4d96c565bb23f961d4fa))
* **deps:** update dependency react-select to v5.10.2 ([#512](https://github.com/0xpiners/neiist-website/issues/512)) ([b88f1e2](https://github.com/0xpiners/neiist-website/commit/b88f1e28bd051aeea1f0ed9d3ab91f72aefe341f))
* **deps:** update mantine monorepo to v8 ([#483](https://github.com/0xpiners/neiist-website/issues/483)) ([6573447](https://github.com/0xpiners/neiist-website/commit/6573447459d67eb62791a8bad74bde3ff055ed85))
* **deps:** update mantine monorepo to v8.1.2 ([#501](https://github.com/0xpiners/neiist-website/issues/501)) ([05382d2](https://github.com/0xpiners/neiist-website/commit/05382d23cfa858c8af4232f83c7af96bdf9ccde6))
* **deps:** update mantine monorepo to v8.1.3 ([#508](https://github.com/0xpiners/neiist-website/issues/508)) ([1c916f6](https://github.com/0xpiners/neiist-website/commit/1c916f6e5fe110f0811fb4c498fd2237bd780052))
* **deps:** update mantine monorepo to v8.2.1 ([#522](https://github.com/0xpiners/neiist-website/issues/522)) ([ef68d08](https://github.com/0xpiners/neiist-website/commit/ef68d084a4c53a7998b21f06b3b8ed8dd06f5517))
* **deps:** update mantine monorepo to v8.2.2 ([#535](https://github.com/0xpiners/neiist-website/issues/535)) ([64c29f6](https://github.com/0xpiners/neiist-website/commit/64c29f618f913a9651bb7e05cc20623dce0cffe8))
* **deps:** update mantine monorepo to v8.2.4 ([#539](https://github.com/0xpiners/neiist-website/issues/539)) ([5498d0d](https://github.com/0xpiners/neiist-website/commit/5498d0d83eff2c7ae78f1657124c57d1cc55cdc7))
* **deps:** update mantine monorepo to v8.3.1 ([#550](https://github.com/0xpiners/neiist-website/issues/550)) ([9260b67](https://github.com/0xpiners/neiist-website/commit/9260b67e0f1c304946bb4d82b05e0b575c0765cf))
* **deps:** update react monorepo to v19 ([#404](https://github.com/0xpiners/neiist-website/issues/404)) ([d57d5c9](https://github.com/0xpiners/neiist-website/commit/d57d5c9edfa86f99b5dbbf079b59e96296b6c353))
* **deps:** update react monorepo to v19.1.1 ([#531](https://github.com/0xpiners/neiist-website/issues/531)) ([97247cf](https://github.com/0xpiners/neiist-website/commit/97247cf946d854866ce6a036aabb88f3dd72c243))
* **dev-tools:** add pre-commit hook, fix setup script ([0a58854](https://github.com/0xpiners/neiist-website/commit/0a588546f74363c06b429a3798e7c3f07f41b034))
* **dev-tools:** SIGINT on yarn dev stops docker container ([0a68173](https://github.com/0xpiners/neiist-website/commit/0a68173f9f0626ccffd3228c3c9aec9059375e89))
* **dev-tools:** updated eslint config for new format used & pre-commit script ([a40d587](https://github.com/0xpiners/neiist-website/commit/a40d587a34d0575474f19ba08268ffcbfe89e3d0))
* **dinner-shop:** orderKind derivation form cart items category ([5f2b47a](https://github.com/0xpiners/neiist-website/commit/5f2b47a6de07b1e1ca3a6412aa642f2ad2620061))
* **dinnerProdcut:** allow multiple products of same special category ([41e5fe8](https://github.com/0xpiners/neiist-website/commit/41e5fe80b49971a4f588a9164eac4cb5a2078a6e))
* **dinner:** refactor dinner page logic and state handling ([c9bf727](https://github.com/0xpiners/neiist-website/commit/c9bf7275fd36eb251f3d14ea44c69bdb8fa64e19))
* **dinner:** remove fullscreen from waiting page (only be used to ([de3b5b8](https://github.com/0xpiners/neiist-website/commit/de3b5b819293130a75879fecfda606c1388df766))
* **discount:** rename folder struct ([c67088c](https://github.com/0xpiners/neiist-website/commit/c67088cb728fdfe10ee4109f264a72b7e7d69ff8))
* **discount:** separated page to manage and create codes ([ed57dab](https://github.com/0xpiners/neiist-website/commit/ed57dabc158fc53bf08aaa068edf2c277e7af63a))
* **docker:** fix naming in docker-compose ([427a370](https://github.com/0xpiners/neiist-website/commit/427a370cb2b512956d995e9274933032b1a69784))
* docs for installation and setup of dev env ([2428b23](https://github.com/0xpiners/neiist-website/commit/2428b23f1eb593435b2cf5bd1cca4cb64105c2b4))
* email now says location to pickup ([d3be9a8](https://github.com/0xpiners/neiist-website/commit/d3be9a86f6595e85a86b495832614972e2bac5bb))
* **email:** add open hours for NEIIST to email and ShopCheckoutOverlay ([7f1732d](https://github.com/0xpiners/neiist-website/commit/7f1732dfbcce78d1a0a82acc08c9e5701b214051))
* **email:** email editor css on DiscountCodesDashboard ([b4d7b66](https://github.com/0xpiners/neiist-website/commit/b4d7b663f2022c7c45a1f138672195dc74ffa5ae))
* **email:** use getFirstandLastName for discount emails ([88db331](https://github.com/0xpiners/neiist-website/commit/88db3316b02fd47c38b27f3f2ee0a6a1d250a5dd))
* **email:** use gmail app password ([37d22cb](https://github.com/0xpiners/neiist-website/commit/37d22cb0a7294446f3aff49b1a209c75855d97a4))
* errors arising from previous merge commit ([35be157](https://github.com/0xpiners/neiist-website/commit/35be157daf2abf3159f045875f75c33510c9c7e2))
* fix Hero and Activities css module issues ([a3b0669](https://github.com/0xpiners/neiist-website/commit/a3b0669e51dc91b1b08dbf3f41f299c2d464f24e))
* **footer-link:** changed page link to reflect correct page ([775bf80](https://github.com/0xpiners/neiist-website/commit/775bf8025ebf26824fc3605844b386bb4726f615))
* **fullscreen:** full screen wrapper ([2dd5e4c](https://github.com/0xpiners/neiist-website/commit/2dd5e4c9401c9b604d20b96d61d55ec984e78efd))
* function order to allow creation of db tables ([b275a36](https://github.com/0xpiners/neiist-website/commit/b275a3624ed749b378f52913b7bfcf6a906b9fb7))
* gitignore ([7fb1b5a](https://github.com/0xpiners/neiist-website/commit/7fb1b5ae0ad508d63a2b98c38b3551e64a282449))
* hydration flash on userdata on website reload after login ([e6a8999](https://github.com/0xpiners/neiist-website/commit/e6a89997ba17effdfe19111a678b87bb56b61ec5))
* ignoring python venv and ensuring init script is run with bash ([28a8b87](https://github.com/0xpiners/neiist-website/commit/28a8b87636f9620f937260b96f13abc04210bb42))
* image imports homepage ([8e807f8](https://github.com/0xpiners/neiist-website/commit/8e807f8288ea34c48973f9cb505764fb3180cc27))
* improve color selection by showing variant colors as colored circles ([962f28a](https://github.com/0xpiners/neiist-website/commit/962f28a080712e5d908f5601582bb0ee6b5e39b4))
* inline editing on safari and webkit browsers ([848d851](https://github.com/0xpiners/neiist-website/commit/848d85156ead2e5f710a21ef0e823a409650f78e))
* **layout:** replace self-loopback HTTP fetch with a server side call to ([311845a](https://github.com/0xpiners/neiist-website/commit/311845a9db1f3b64d934acb8f4ba4bb3856eb2df))
* **layout:** static render navbar only auth widget is dynamic ([7354025](https://github.com/0xpiners/neiist-website/commit/7354025dc6ca1ce06ec562f4135223f476ddf650))
* location tag on events sync ([45dffa2](https://github.com/0xpiners/neiist-website/commit/45dffa24425e0c77ac8257c328fce50fdf8df119))
* **login:** use correct base url on redirect ([6223f35](https://github.com/0xpiners/neiist-website/commit/6223f357658ce85ff54e2e5c579622ef73324ec7))
* logout redurect use next base url ([b18ee94](https://github.com/0xpiners/neiist-website/commit/b18ee94a3c35d534d61a635914d9dbbcec4b3984))
* **memberCard:** show linkedin username ([e2283f9](https://github.com/0xpiners/neiist-website/commit/e2283f944a9e36148b569d537b9d5ec6c1472051))
* memberships api permissions fixed, better variables names and error ([b19b828](https://github.com/0xpiners/neiist-website/commit/b19b8284dbed2658a4ea10652b1176ede285b0be))
* middleware allow images from public folder ([84cfc02](https://github.com/0xpiners/neiist-website/commit/84cfc026faaed1bc334caa885d80383547eeb681))
* middleware serve images from public (png, svg) ([8fe9449](https://github.com/0xpiners/neiist-website/commit/8fe9449903f04f3aae137469189146c0461cc175))
* mobile scalling for activities slider and about-us team grid ([6672721](https://github.com/0xpiners/neiist-website/commit/6672721fa1d02448c1db6f99cf22332a5371f69f))
* mobile scalling on the shop and product details page ([05d65c0](https://github.com/0xpiners/neiist-website/commit/05d65c0161f555fc3b234492e252fe4955de6f28))
* name of hero assets ([1deadc4](https://github.com/0xpiners/neiist-website/commit/1deadc4c5a3a03c754902b64e00a0a6578f2efb7))
* navbar closing animation on mobile ([e2b9b7e](https://github.com/0xpiners/neiist-website/commit/e2b9b7e1e5d01568bf145b5816f65c4cb8ff70ea))
* navbar dropdown on 768px devices and icon picker search adjust ([0171143](https://github.com/0xpiners/neiist-website/commit/01711437e6c32d4a069329f42e21cda43968aeeb))
* new fuzzy search params for User search on NewOrderModal ([a740f1e](https://github.com/0xpiners/neiist-website/commit/a740f1e4c1717a06ceedb090eeb296213d886955))
* new membership data type + code refactor ([bed3dce](https://github.com/0xpiners/neiist-website/commit/bed3dceebc0d2bc320b8adb50df4f334442a7332))
* new orders stock override dialog formating ([df55824](https://github.com/0xpiners/neiist-website/commit/df55824bab164b0196c4ab738088f65103324f15))
* notion api auth headers for google calendar integration ([3a333f1](https://github.com/0xpiners/neiist-website/commit/3a333f1963e83b4b5ee6c263d68ee9cce41f5443))
* notion api database query method ([f79655d](https://github.com/0xpiners/neiist-website/commit/f79655dc6117a20de6db775c28dad51ab335bd97))
* notion api webhook with validation using @notionhq/client ([82c7f51](https://github.com/0xpiners/neiist-website/commit/82c7f514faa09f9eb2c6f808493bf6b8e3bf60b7))
* notion calemndar api using webhook and cache ([9a7aed5](https://github.com/0xpiners/neiist-website/commit/9a7aed5c065977e166accda4fe464db9eed06622))
* orderKind payment methods for Jantar de Curso ([2545e9f](https://github.com/0xpiners/neiist-website/commit/2545e9fc8486c44e024c0564f05b7ec941f53dfa))
* **orders:** add updated_by/updated_at fields to track alterations to orders. Also added to excel export. ([5efd9e9](https://github.com/0xpiners/neiist-website/commit/5efd9e9fc247f415cf5133f2cd485cdc6e40bdef))
* password mismatch example env and setup.sh with schema ([05cbb8d](https://github.com/0xpiners/neiist-website/commit/05cbb8dc548bc8d39b531112f69d6eab5cdf81d3))
* paths to .md files ([4aa43ae](https://github.com/0xpiners/neiist-website/commit/4aa43ae2108549f62410d7d4b1bd73a02316bce0))
* **payment:** correct enum for POS payment methods for normal categories ([f1054df](https://github.com/0xpiners/neiist-website/commit/f1054dfc80fdacf112e89e1c2a3c31742db1a3bc))
* phone number saving on new order creation and user order canceling ([0abda28](https://github.com/0xpiners/neiist-website/commit/0abda28b41eedb551a2524b884d5ac8c226592c2))
* photo management card ([a53cf59](https://github.com/0xpiners/neiist-website/commit/a53cf592891946cd5f1c4a665cfc1138402cd8d8))
* Product Details images. ([6d64956](https://github.com/0xpiners/neiist-website/commit/6d6495680591bfa5baa3edba05bfe3dcb021b587))
* **products:** image upload format ([4e8b8c0](https://github.com/0xpiners/neiist-website/commit/4e8b8c089f06ee7a405c8da3ba8b6ca31efde0f6))
* profile page css ([2a8bada](https://github.com/0xpiners/neiist-website/commit/2a8bada2e69e9a81fb18ce0701e49d1fdb73f1d7))
* **profile:** now able to delete contacts methods and update the data on the locked section can only be changed on fenix ([269c04d](https://github.com/0xpiners/neiist-website/commit/269c04dbe9301596a92da5c0c6f5df4893dadf5e))
* refactor excel orders export ([5177190](https://github.com/0xpiners/neiist-website/commit/51771909f360fe8c7d3dc7892be421fcac8debfc))
* remove broken dependencies from the shop ([ab35cc6](https://github.com/0xpiners/neiist-website/commit/ab35cc66cee448948060c8eaca0d6397cc4eb289))
* remove unused fenix (tecnico api v2) scopes ([713253f](https://github.com/0xpiners/neiist-website/commit/713253f90b47ca2f93dd220dcb0024105edb5d47))
* route url redirect to confirmation page ([0cae6c0](https://github.com/0xpiners/neiist-website/commit/0cae6c0cac8ae85a467fcd1d40730bd975b9ced2))
* **scripts:** input validation in setup.sh and remove deprecated version in docker-compose.yml. ([e963034](https://github.com/0xpiners/neiist-website/commit/e963034f36c03f2295783019cde024b5ad30bb99))
* **scripts:** manage manage-calendars, setup google and setup notion ([a1cb866](https://github.com/0xpiners/neiist-website/commit/a1cb8662e23d1770969ebceb6c7f8f8e44a29ff9))
* search users on NewOrderModal ([238cfd1](https://github.com/0xpiners/neiist-website/commit/238cfd160411012eff4b1a5e12abcff256371b64))
* **setup:** Script was referencing old location of script. ([77368e8](https://github.com/0xpiners/neiist-website/commit/77368e840fef2f66b79838b562e3ef68bb739d43))
* shop schema name for payment_checked_by ([3f530f1](https://github.com/0xpiners/neiist-website/commit/3f530f1beb92f4c292d429e121834531fcb241b6))
* **shop:** add links for availability on tagus and alameda, new custom ([2bcfcfb](https://github.com/0xpiners/neiist-website/commit/2bcfcfb0b0003fafba125f45380fa43d83b92136))
* **shop:** add override for status labels, with conditional messages for ([3d72068](https://github.com/0xpiners/neiist-website/commit/3d720683f4db6a1ab37eb60bf04efc58765a0d4f))
* **shop:** all db to object mappers use the new product variants parser ([f2574c5](https://github.com/0xpiners/neiist-website/commit/f2574c5c2166c0a7366caa4a76c48b9eafb6e7c6))
* **shop:** allow add-to-cart for products without variants ([75811d3](https://github.com/0xpiners/neiist-website/commit/75811d305528ba98574b44e2ba3042b0b2beeb67))
* **shop:** allow sending discount code to external emails (non neiist ([aae8b4b](https://github.com/0xpiners/neiist-website/commit/aae8b4b45e6ae31d34b5d025f06acac42d968fc5))
* **shop:** change max upload size of files for images ([1fd57bc](https://github.com/0xpiners/neiist-website/commit/1fd57bc699e7ee8f06cc2d861b819cdfa86522f3))
* **shop:** correctly identify OrderKind on CheckoutForm and ProductDetails ([4f970fb](https://github.com/0xpiners/neiist-website/commit/4f970fbc3ebdcba1dfa9ee9d199de4c18ad671ad))
* **shop:** css changes ([5af7d4c](https://github.com/0xpiners/neiist-website/commit/5af7d4cbada744ac328111a8776c45aec5caf2ec))
* **shop:** dicount code managment page button on shop managment ([2571eee](https://github.com/0xpiners/neiist-website/commit/2571eee78ce8685a8833a23cb4b69159c8dc7d6d))
* **shop:** email editor for discountEmail now supports more variables ([9ac80ca](https://github.com/0xpiners/neiist-website/commit/9ac80ca2b78d44878e9dbdbb30e3ffcdd7f787ef))
* **shop:** make payment_reference and order number visible at all times ([18583ce](https://github.com/0xpiners/neiist-website/commit/18583ce132c12303c347838cb3b757c59a19cdb2))
* **shop:** new messages for payment order overlay confirmation ([9987bfe](https://github.com/0xpiners/neiist-website/commit/9987bfe273ed36fd1f5e9ed4f81dd97949791fc4))
* **shop:** prevent race condion and duplicate emails in order finalization ([87e11e2](https://github.com/0xpiners/neiist-website/commit/87e11e269d150a477ac52a944532b8f9e8206971))
* **shop:** product variants are now correctly order and saved ([3700853](https://github.com/0xpiners/neiist-website/commit/37008539b0b7cd2689104def912630d3a5f6e640))
* **shop:** progres steps for special categories, show on order details ([3026a0a](https://github.com/0xpiners/neiist-website/commit/3026a0ab122d1a31da04bb932ab6386b2325fc03))
* **shop:** show apple pay option correct ([fc9a688](https://github.com/0xpiners/neiist-website/commit/fc9a688e8666f9f7e1ad753bf1e83e12efa41cd3))
* **shop:** show on NewOrderModal and PosPaymentOverlay POS flow the ([aedc23c](https://github.com/0xpiners/neiist-website/commit/aedc23c05f059a9ea67058eb281f66e0062c6344))
* **shop:** variant order and block cart updates for special categories ([967ec51](https://github.com/0xpiners/neiist-website/commit/967ec51d908f5b82c3509b06d37e58f245c6514a))
* **shop:** when POS flow fails/exit set order as pending (in-person) as ([08ca0fc](https://github.com/0xpiners/neiist-website/commit/08ca0fca0936e9cde69648c1f2c4a0ffd235170b))
* show all academic years on the about us page ([01ed4c7](https://github.com/0xpiners/neiist-website/commit/01ed4c7986d83d2e5b88ea8c1675c59bcf8944eb))
* show first name, last name and position on the user menu ([d7617d5](https://github.com/0xpiners/neiist-website/commit/d7617d5d214de8d917abca62431e49f2a4e29f24))
* small scalling issues on mobile and larger screens ([c664894](https://github.com/0xpiners/neiist-website/commit/c664894748cf73927c3cd77a0c1aa410662f87bb))
* sql getter functions ([60e1fa4](https://github.com/0xpiners/neiist-website/commit/60e1fa444b20615cbf585a35ae716c7ca05bd829))
* style of descprition on the activity card ([1d66e5d](https://github.com/0xpiners/neiist-website/commit/1d66e5d1e770b12c94db3582090f4b0157066ce3))
* **style:** about us description font size and scalling. Home page activities scalling on mobile ([4fb25ea](https://github.com/0xpiners/neiist-website/commit/4fb25ea5add94907316966c42a7254940475d467))
* **styles:** adjust margins and alignment for improved layout on DinnerPage ([8839a0c](https://github.com/0xpiners/neiist-website/commit/8839a0c2b19b87187494dd599f1fb756e823e0ca))
* **styles:** adjust margins and layout for improved spacing on DinnerPage ([92331e9](https://github.com/0xpiners/neiist-website/commit/92331e9917b88df2bae62f1f76bb1ae896d720ef))
* **styles:** mobile scalling fixed for some components. ([b445e3b](https://github.com/0xpiners/neiist-website/commit/b445e3bb10109bbc223b5d608b419a644d49f7e0))
* **styles:** normalize margins for main title and welcome message in DinnerSurprises ([0b9de7f](https://github.com/0xpiners/neiist-website/commit/0b9de7fcfb606a3163f4bcd0ba532b2c42b19aa0))
* sumup use amount information from db not client ([4e5304a](https://github.com/0xpiners/neiist-website/commit/4e5304a911fe2608e63e5291b276eea998c70970))
* **sumup:** better product descprition ([e9adf9b](https://github.com/0xpiners/neiist-website/commit/e9adf9b1e6713659a6ccc0da54d7fc21c3cb1323))
* **sumup:** send complete descprition with list of products in order, ([86178f4](https://github.com/0xpiners/neiist-website/commit/86178f40a9d6a7893dd808ec4667f636fd117d0a))
* **sumup:** singleton client error handeling and overlay index ([fca7aa4](https://github.com/0xpiners/neiist-website/commit/fca7aa48adc9b1b153ecfeaede73773e803e8d99))
* **sumup:** verify exact cent amount match and currencybind ([d034dcf](https://github.com/0xpiners/neiist-website/commit/d034dcf62a48fba583b3938d595ca3b4ad8b720d))
* **toast:** add toast notifications instead of inline erros for ([4ac4853](https://github.com/0xpiners/neiist-website/commit/4ac4853971b4247285cbfce70aa2924acc35da54))
* typo on campus settings on email template ([e246431](https://github.com/0xpiners/neiist-website/commit/e246431bf68cd694a817387b029ad7f92c24fcaa))
* typo on deploy actions ([660d965](https://github.com/0xpiners/neiist-website/commit/660d965c79c38079b70516f94ec716c78af66667))
* **UnauthorizedPage:** fixed size it is now centenred and shows footer and navbar. ([9433131](https://github.com/0xpiners/neiist-website/commit/9433131662c4e5e857ebfecaa0a67926b7cce63a))
* update Node.js version to 24.11.1 in .nvmrc and installation guide ([2747fd2](https://github.com/0xpiners/neiist-website/commit/2747fd2b2c64685862ad616e64ddf2dab11b619d))
* Updated url of links in the user menu. ([27f5cc0](https://github.com/0xpiners/neiist-website/commit/27f5cc041908287f77990f63dee44b684a1154a5))
* use webcal for google calendar subscripition ([5b277c7](https://github.com/0xpiners/neiist-website/commit/5b277c71a28f729060cff1561fb0fbbf44f56bec))
* **userContext:** user context now auto reload on sucessful login ([ca7059d](https://github.com/0xpiners/neiist-website/commit/ca7059d5c286dfae20cd6fc9e14426cf6cb1d476))
* **voting:** fix SSE and pg_notify memory and db connections leak. UI/UX improvements on the user vonting screen ([c20dc75](https://github.com/0xpiners/neiist-website/commit/c20dc7516db350f3eb97cc7717e9f8e8eea617e3))
* when adding a new department it ask/reminds the user to add the new roles for that department. ([8ea7c9d](https://github.com/0xpiners/neiist-website/commit/8ea7c9dff7fb456cb911a2e2d55a3ee2d06ba644))


### Miscellaneous Chores

* migrate to pnpm, new db seed script and updated deployments ([55ff382](https://github.com/0xpiners/neiist-website/commit/55ff382af397652d7d7119b306e2416d651cc847)), closes [#656](https://github.com/0xpiners/neiist-website/issues/656)
